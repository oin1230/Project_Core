...
public class ShuttleVO {
	...
	public ShuttleVO(int shtl_id, String start_rg, int shtl_num, String start_date, String end_date, String riding_date,
			String shtl_state, int event_id, String event_img, String event_name, String event_loc, int RG_PRICE) {
