...
<body>
  ...
  <div class="container-fluid fixed-top">
    <div class="container px-0">
      <nav class="navbar navbar-light bg-white navbar-expand-xl">
        <a href="gomain.do" class="navbar-brand">
        ...
        <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
          <div class="navbar-nav mx-auto">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu m-0 bg-secondary rounded-0">
                <a href="board.jsp" class="dropdown-item">자유게시판</a>
                <a href="board.jsp" class="dropdown-item">질문게시판</a>
                <a href="board.jsp" class="dropdown-item">후기게시판</a>
              </div>
            </div>
            <div class="nav-item dropdown">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">INFO CENTER</a>
              <div class="dropdown-menu m-0 bg-secondary rounded-0">
                <a href="qna.jsp" class="dropdown-item">Q&A</a>
                <a href="announcement.jsp" class="dropdown-item">공지사항</a>
          ...
          <div class="d-flex m-3 me-0">
            ...
            <a href="signin.jsp" class="my-auto">
            ...
            <!--로그인 시 나타날 마이페이지 버튼-->
            <c:if test="${member != null }">
            <a href="myPage.jsp" class="my-auto">
              <i class="fas fa-user fa-2x"></i>
            </a>
            </c:if>
          </div>
  ...
  <body class="signIn">
          ...
          <form action ="Join.do" class="validation-form" novalidate>
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="name" name="email" placeholder="" value="" required>
                <div>여기에 비동기 확인</div>
              </div>
              <div class="col-md-6 mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="password" class="form-control" id="pw_check" name="pw_check" placeholder="" required>
            </div>
            ...
            <div class="mb-3">
              ...
              <input list="Address_option" class="inputset-input form-control" id="address" name="address">
            ...
            <div class="mb-4"></div>
            <button class="btn btn-primary btn-lg btn-block right-align" type="submit">가입 완료</button>
          </form>
        </div>
      </div>
    </div><br><br>
    <div>
      ...
      <div class="signdriver"><a href="#">운전자 회원가입</a></div>
    </div>
