        ...
        <div class="input-form col-md-12 mx-auto">
          ...
          <form class="validation-form" novalidate>
            ...
            <div class="mb-3">
              ...
              <input type="password" class="form-control" id="pw_check" placeholder="" required>
            </div>

            <div class="mb-3">
              <label for="phone">핸드폰번호</label>
              <input type="text" class="form-control" id="phonenumber" placeholder="010-1234-5678" required>
            </div>


            <div class="mb-3">
              <label for="address">주소</label>
              <input list="Address_option" class="inputset-input form-control" id="address">
